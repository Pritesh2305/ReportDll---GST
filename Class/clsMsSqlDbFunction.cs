...
namespace ReportDll
{
    public class clsMsSqlDbFunction : clsPublicVariables 
    {
        ...
        private bool OpenMsSqlDataConnection()
        {
            ...
            {
                MessageBox.Show(ex.Message.ToString() + " Error occures in OpenMsSqlDataConnection())", clsPublicVariables.Project_Title, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return false;
            }
        }
